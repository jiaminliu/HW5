...
<h2 class="title">Please update the quantity of the item after the sale.</h2>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>" 
        SelectCommand="SELECT [StyleID], [Category], [Color], [Quantity], [Sizes] FROM [Shoes]" 
        DeleteCommand="DELETE FROM [Shoes] WHERE [StyleID] = @StyleID" 
        InsertCommand="INSERT INTO [Shoes] ([Category], [Color], [Quantity], [Sizes]) VALUES (@Category, @Color, @Quantity, @Sizes)" 
        
        UpdateCommand="UPDATE [Shoes] SET [Category] = @Category, [Color] = @Color, [Quantity] = @Quantity, [Sizes] = @Sizes WHERE [StyleID] = @StyleID">
        <DeleteParameters>

<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Add New Shoe.aspx.vb" Inherits="detailsview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:DetailsView ID="DetailsView1" runat="server" AllowPaging="True" 
        ...
        AutoGenerateRows="False" DataKeyNames="StyleID" DefaultMode="Insert">
        <Fields>
